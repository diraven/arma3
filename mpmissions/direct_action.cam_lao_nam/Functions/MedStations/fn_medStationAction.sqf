	...
	_obj = param [0, player];
			...
			[
					_obj,																							// Object the action is attached to
					 "<t color='#FFC0CB'>Treat At Medical Station",													// Title of the action
					...
					"(_target distance cursorObject < 5) and (cursorObject getVariable 'BEW_v_MedicalStation')",	// Condition for the action to be shown
