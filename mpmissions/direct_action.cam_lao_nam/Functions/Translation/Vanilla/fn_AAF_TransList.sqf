	...
	// Vehicles		
		...
		_quadBike 				=	"I_Quadbike_01_F";
		
		_smallCargoTruck = switch (true) do {

			case (isClass(configfile >> "CfgVehicles" >> "I_Truck_02_flatbed_lxWS")): {"I_Truck_02_flatbed_lxWS"};
			default {"C_Van_01_transport_F"};
