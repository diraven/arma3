	...
	// Vehicles
		...
		_lightIFV = switch (true) do {
			...
			case (isClass(configfile >> "CfgVehicles" >> "I_LT_01_Cannon_LDF_F")): {"I_LT_01_Cannon_LDF_F"};
			default {"I_LT_01_cannon_F"};

		};

		_lightAA = switch (true) do {

			case (isClass(configfile >> "CfgVehicles" >> "I_LT_01_AA_LDF_F")): {"I_LT_01_AA_LDF_F"};
		...
		_tank = switch (true) do {
			...
			case (isClass(configfile >> "CfgVehicles" >> "I_MBT_03_Cannon_LDF_F")): {"I_MBT_03_Cannon_LDF_F"};
			default {"B_T_MBT_01_TUSK_F"};
		...
		_wheeledIFV = switch (true) do {
			...
			case (isClass(configfile >> "CfgVehicles" >> "I_APC_Wheeled_03_Cannon_LDF_F")): {"I_APC_Wheeled_03_Cannon_LDF_F"};
			default {"B_T_APC_Wheeled_01_cannon_F"};
		...
		_largeTrHeli = switch (true) do {
			...
			case (isClass(configfile >> "CfgVehicles" >> "I_Heli_Transport_02_LDF_F")): {"I_Heli_Transport_02_LDF_F"};
		...
		_plane_L1 = switch (true) do {
			...
			case (isClass(configfile >> "CfgVehicles" >> "C_Plane_Civil_01_LDF_F")): {"C_Plane_Civil_01_LDF_F"};
		...
		_plane_L6 = switch (true) do {
			...
			case (isClass(configfile >> "CfgVehicles" >> "I_Plane_Fighter_04_LDF_F")): {"I_Plane_Fighter_04_LDF_F"};
			default {"I_Plane_Fighter_04_Cluster_F"};

		};
		
		_smallBoat					=	"Flag_EAF_F";
		_sub 				=	"flag_EAF";
