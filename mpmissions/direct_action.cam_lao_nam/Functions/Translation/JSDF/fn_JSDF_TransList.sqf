	...
	// Units
		...
		_rifleman				=	"Japan_JP_Jeitai_Soldier_Base";
		_officer 				=	"Japan_JP_Jeitai_officer";
		_teamLeader 			= 	"Japan_JP_Jeitai_Soldier_TL";
		_marksman 				= 	"Japan_JP_Jeitai_soldier_M";
		_sniper					=	"Japan_JP_Jeitai_soldier_M";
		_spotter				=	"Japan_JP_Jeitai_recon";
		_grenadier				=	"Japan_JP_Jeitai_Soldier_GL";
		_autoRifleman			= 	"Japan_JP_Jeitai_soldier_AR";
		_gunner					=	"Japan_JP_Jeitai_soldier_AR";
		_medic					= 	"Japan_JP_Jeitai_Soldier_Tshirt";
		_repairSpecialist		=	"Japan_JP_Jeitai_soldier_repair";
		_engineer				= 	"Japan_JP_Jeitai_Soldier_Vest";
		_guidedLAT				=	"Japan_JP_Jeitai_recon_LAT";
		_dumbLAT				=	"Japan_JP_Jeitai_Soldier_LAT";
		_missileSpecialistAT	= 	"Japan_JP_Jeitai_soldier_AT";
		_missileSpecialistAA	=	"Japan_JP_Jeitai_soldier_AA";
		_ammoBearer				= 	"Japan_JP_Jeitai_Soldier_Base";
		_JTAC					= 	"Japan_JP_Jeitai_recon_JTAC";
		_explosivesSpecialist	= 	"Japan_JP_Jeitai_soldier_exp";
		_uavOperator			= 	"Japan_JP_Jeitai_soldier_UAV";
		_paratrooper			=	"Japan_JP_Jeitai_soldier_PG";
		_heliPilot 				=	"Japan_JP_Jeitai_Soldier_F";
		_heliCrew				=	"Japan_JP_Jeitai_Soldier_F";
		_fighterPilot			=	"Japan_JP_Jeitai_Soldier_F";
		_pilot					=	"Japan_JP_Jeitai_Soldier_F";
