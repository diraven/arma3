	...
	// Units
		...
		_rifleman				=	"TFC_C_Soldier_OTW_Rifleman_AR_F";
		_officer 				=	"TFC_C_Soldier_OTW_Officer_AR_F";
		_teamLeader 			= 	"TFC_C_Soldier_OTW_IC_AR_F";
		_marksman 				= 	"TFC_C_Soldier_OTW_Marksman_AR_F";
		_sniper					=	"TFC_C_Soldier_OTW_Marksman_AR_F";
		_spotter				=	"TFC_C_Soldier_OTW_Rifleman_Lite_AR_F";
		_grenadier				=	"TFC_C_Soldier_OTW_Grenadier_AR_F";
		_autoRifleman			= 	"TFC_C_Soldier_OTW_C9_AR_F";
		_gunner					=	"TFC_C_Soldier_OTW_C6_AR_F";
		_medic					= 	"TFC_C_Soldier_OTW_Medic_AR_F";
		_repairSpecialist		=	"TFC_C_Soldier_OTW_Engineer_AR_F";
		_engineer				= 	"TFC_C_Soldier_OTW_Engineer_AR_F";
		_guidedLAT				=	"TFC_C_Soldier_OTW_M72_AR_F";
		_dumbLAT				=	"TFC_C_Soldier_OTW_M72_AR_F";
		_missileSpecialistAT	= 	"TFC_C_Soldier_OTW_CarlG_AR_F";
		_missileSpecialistAA	=	"TFC_C_Soldier_Tunic_CarlG_AR_F";
		_ammoBearer				= 	"TFC_C_Soldier_OTW_Rifleman_AR_F";
		_JTAC					= 	"TFC_C_Soldier_Tunic_Rifleman_Lite_AR_F";
		_explosivesSpecialist	= 	"TFC_C_Soldier_OTW_Engineer_AR_F";
		_uavOperator			= 	"TFC_C_Soldier_OTW_Universal_AR_F";
		_paratrooper			=	"TFC_C_Soldier_OTW_Paratrooper_AR_F";
		...
		_vehicleCrew			=  	"TFC_C_Soldier_OTW_Crewman_AR_F";
		_diver 					=	"B_diver_F";
	...
	// Vehicles
		...
		_car					=	"TFC_vs_luvw_Arid_F";
		_carHMG					=	"TFC_vs_luvw_arid_armed_F";
		_carAT					=	"rhsusf_m1045_d";		
		_Mrap					=	"rhsusf_m1151_usarmy_d";
		_MrapHMG				=	"rhsusf_m1151_m2crows_usarmy_d";
		_MrapGMG				=	"rhsusf_m1151_mk19crows_usarmy_d";
		_cargoTruck				=	"B_Truck_01_flatbed_F";
		_lightIFV				=	"TFC_APC_Wheeled_TAPV_GMG_C6_AR_F";
		_lightAA				=	"TFC_APC_Wheeled_TAPV_GMG_C6_AR_F";
		_tank					=	"TFC_MBT_Leopard2A6M_Arid";
		_antiAirAPC				=	"RHS_M6";
		_artilleryAPC			=	"rhsusf_m109d_usarmy";

		_wheeledIFV = switch (true) do {
			case (isClass(configfile >> "CfgVehicles" >> "TFC_Wheeled_LAV6_ISC_AR")): {"TFC_Wheeled_LAV6_ISC_AR"};
			default {"rhsusf_stryker_m1126_mk19_d"};				
		};
		
		_trackedAPC				=	"RHS_M2A2_BUSKI";		
