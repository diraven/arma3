	...
	// Units
		...
		_rifleman				= 	"vn_b_men_aus_sas_70_12";
		_officer 				=	"vn_b_men_aus_army_70_22";
		_teamLeader 			= 	"vn_b_men_aus_sas_70_01";
		_marksman 				= 	"vn_b_men_aus_sas_70_03";
		_sniper					=	"vn_b_men_aus_sas_70_03";
		_spotter				=	"";
		_grenadier				=	"vn_b_men_aus_sas_70_09";
		_autoRifleman			= 	"vn_b_men_aus_sas_70_07";
		_gunner					=	"";
		_medic					= 	"vn_b_men_aus_sas_70_05";
		_repairSpecialist		=	"";
		_engineer				= 	"vn_b_men_aus_sas_70_08";
		_guidedLAT				=	"";
		_dumbLAT				=	"";
		_missileSpecialistAT	= 	"vn_b_men_aus_sas_70_10";
		_missileSpecialistAA	=	"vn_b_men_aus_sas_70_10";
		_ammoBearer				= 	"";
		_JTAC					= 	"vn_b_men_aus_sas_70_02";
		_explosivesSpecialist	= 	"vn_b_men_aus_sas_70_08";
		_uavOperator			= 	"vn_b_men_aus_sas_70_13";
		_paratrooper			=	"";
