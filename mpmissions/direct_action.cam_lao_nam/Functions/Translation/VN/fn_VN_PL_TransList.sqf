	...
	// Units
		...
		_rifleman				= 	"vn_o_men_pl_06";
		_officer 				=	"vn_o_men_pl_01";
		_teamLeader 			= 	"vn_o_men_pl_21";
		_marksman 				= 	"vn_o_men_pl_10";
		_sniper					=	"";
		_spotter				=	"";
		_grenadier				=	"vn_o_men_pl_07";
		_autoRifleman			= 	"vn_o_men_pl_25";
		_gunner					=	"";
		_medic					= 	"vn_o_men_pl_28";
		_repairSpecialist		=	"";
		_engineer				= 	"vn_o_men_pl_09";
		_guidedLAT				=	"";
		_dumbLAT				=	"";
		_missileSpecialistAT	= 	"vn_o_men_pl_14";
		_missileSpecialistAA	=	"vn_o_men_pl_14";
		_ammoBearer				= 	"";
		_JTAC					= 	"vn_o_men_pl_13";
		_explosivesSpecialist	= 	"vn_o_men_pl_09";
		_uavOperator			= 	"";
		_paratrooper			=	"";
	...
	// Vehicles
		...
		_tankHunter 				= switch (true) do {
			...
			default {"vn_o_armor_pt76a_01_pl"};				
		};
