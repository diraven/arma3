		...
		_rifleman				= 	"vn_b_men_lrrp_07";
		_officer 				=	"vn_b_men_sog_22";
		_teamLeader 			= 	"vn_b_men_sog_04";
		_marksman 				= 	"vn_b_men_sog_12";
		_sniper					=	"vn_b_men_sog_21";
		_spotter				=	"";
		_grenadier				=	"vn_b_men_sog_07";
		_autoRifleman			= 	"vn_b_men_sog_16";
		_gunner					=	"";
		_medic					= 	"vn_b_men_sog_20";
		_repairSpecialist		=	"";
		_engineer				= 	"vn_b_men_sog_08";
		_guidedLAT				=	"";
		_dumbLAT				=	"";
		_missileSpecialistAT	= 	"vn_b_men_sog_09";
		_missileSpecialistAA	=	"vn_b_men_sog_09";
		_ammoBearer				= 	"";
		_JTAC					= 	"vn_b_men_sog_05";
		_explosivesSpecialist	= 	"vn_b_men_sog_08";
		_uavOperator			= 	"vn_b_men_sog_19";
		_paratrooper			=	"";
