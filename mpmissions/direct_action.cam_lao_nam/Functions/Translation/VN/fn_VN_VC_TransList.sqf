	...
	// Units
		...
		_rifleman				= 	"vn_o_men_vc_06";
		_officer 				=	"vn_o_men_vc_01";
		_teamLeader 			= 	"";
		_marksman 				= 	"vn_o_men_vc_10";
		_sniper					=	"";
		_spotter				=	"";
		_grenadier				=	"vn_o_men_vc_07";
		_autoRifleman			= 	"vn_o_men_vc_11";
		_gunner					=	"";
		_medic					= 	"";
		_repairSpecialist		=	"";
		_engineer				= 	"vn_o_men_vc_09";
		_guidedLAT				=	"";
		_dumbLAT				=	"";
		_missileSpecialistAT	= 	"vn_o_men_vc_14";
		_missileSpecialistAA	=	"v";
		_ammoBearer				= 	"";
		_JTAC					= 	"vn_o_men_vc_13";
	...
	// Vehicles
		...
		_car					=	"vn_o_car_01_01";
		_carHMG					=	"vn_o_car_02_01";
		_carAT					=	"vn_o_car_04_mg_01";
