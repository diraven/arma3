	...
	// Units
		...
		_rifleman				= 	"vn_b_men_seal_10";
		_officer 				=	"vn_b_men_seal_07";
		_teamLeader 			= 	"vn_b_men_seal_01";
		_marksman 				= 	"vn_b_men_seal_13";
		_sniper					=	"vn_b_men_army_11";
		_spotter				=	"";
		_grenadier				=	"vn_b_men_seal_08";
		_autoRifleman			= 	"vn_b_men_seal_05";
		_gunner					=	"";
		_medic					= 	"vn_b_men_seal_02";
		_repairSpecialist		=	"";
		_engineer				= 	"vn_b_men_seal_03";
		_guidedLAT				=	"";
		_dumbLAT				=	"";
		_missileSpecialistAT	= 	"vn_b_men_seal_11";
		_missileSpecialistAA	=	"vn_b_men_seal_11";
		_ammoBearer				= 	"";
		_JTAC					= 	"vn_b_men_seal_06";
		_explosivesSpecialist	= 	"vn_b_men_army_05";
	...
	// Vehicles
		...
		_attackBoat				=	["vn_b_boat_05_02", "vn_b_boat_06_02"];
		_quadBike 				=	"";
