	...
	// Units
		...
		_rifleman				= 	"vn_b_men_army_15";
		_officer 				=	"vn_b_men_army_01";
		_teamLeader 			= 	"vn_b_men_army_02";
		_marksman 				= 	"vn_b_men_army_10";
		_sniper					=	"vn_b_men_army_11";
		_spotter				=	"";
		_grenadier				=	"vn_b_men_army_07";
		_autoRifleman			= 	"vn_b_men_army_06";
		_gunner					=	"";
		_medic					= 	"vn_b_men_army_03";
		_repairSpecialist		=	"";
		_engineer				= 	"vn_b_men_army_04";
		_guidedLAT				=	"";
		_dumbLAT				=	"";
		_missileSpecialistAT	= 	"vn_b_men_army_12";
		_missileSpecialistAA	=	"vn_b_men_army_12";
		_ammoBearer				= 	"";
		_JTAC					= 	"vn_b_men_army_08";
