	...
	// Units
		...
		_officer 				=	"CUP_B_US_SpecOps_TL";
		_teamLeader 			= 	"CUP_B_US_SpecOps_TL";
		_marksman 				= 	"CUP_B_US_SpecOps_M";
		_sniper					=	"CUP_B_US_Sniper_OCP";
		_spotter				=	"CUP_B_US_Spotter_OCP";
		_grenadier				=	"CUP_B_US_Soldier_GL_OCP";
		_autoRifleman			= 	"CUP_B_US_SpecOps_AR";
		_gunner					=	"CUP_B_US_SpecOps_MG";
		_medic					= 	"CUP_B_US_SpecOps_Medic";
		...
		_uavOperator			= 	"CUP_B_US_SpecOps_UAV";
	...
	// Vehicles
		...
		_carHMG					=	"CUP_B_HMMWV_SOV_M2_USA";
		_carAT					=	"CUP_B_HMMWV_SOV_USA";
