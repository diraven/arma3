	...
	// Units
		...
		_rifleman				= 	"O_SFIA_soldier_lxWS";
		_officer 				=	"O_SFIA_officer_lxWS";
		_teamLeader 			= 	"O_SFIA_Soldier_TL_lxWS";
		_marksman 				= 	"O_SFIA_sharpshooter_lxWS";
		_sniper					=	"";
		_spotter				=	"";
		_grenadier				=	"O_SFIA_Soldier_GL_lxWS";
		_autoRifleman			= 	"O_SFIA_Soldier_AR_lxWS";
		_gunner					=	"";
		_medic					= 	"O_SFIA_medic_lxWS";
		_repairSpecialist		=	"O_SFIA_repair_lxWS";
		_engineer				= 	"O_SFIA_repair_lxWS";
		_guidedLAT				=	"";
		_dumbLAT				=	"";
		_missileSpecialistAT	= 	"O_SFIA_soldier_at_lxWS";
		_missileSpecialistAA	=	"O_SFIA_soldier_aa_lxWS";
		_ammoBearer				= 	"";
		_JTAC					= 	"";
		_explosivesSpecialist	= 	"O_SFIA_exp_lxWS";
		_uavOperator			= 	"";
		_paratrooper			=	"";
