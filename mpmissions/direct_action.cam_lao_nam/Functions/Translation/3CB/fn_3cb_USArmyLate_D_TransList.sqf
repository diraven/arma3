	...
	// Units
		...
		_rifleman				= 	"UK3CB_CW_US_B_LATE_RIF_1";
		_officer 				=	"UK3CB_CW_US_B_LATE_OFF";
		_teamLeader 			= 	"UK3CB_CW_US_B_LATE_TL";
		_marksman 				= 	"UK3CB_CW_US_B_LATE_MK";
		_sniper					=	"UK3CB_CW_US_B_LATE_SF_SNI";
		_spotter				=	"UK3CB_CW_US_B_LATE_SF_SPOT";
		_grenadier				=	"UK3CB_CW_US_B_LATE_GL";
		_autoRifleman			= 	"UK3CB_CW_US_B_LATE_AR";
		_gunner					=	"UK3CB_CW_US_B_LATE_MG";
		_medic					= 	"UK3CB_CW_US_B_LATE_MD";
		_repairSpecialist		=	"UK3CB_CW_US_B_LATE_ENG";
		_engineer				= 	"UK3CB_CW_US_B_LATE_ENG";
		_guidedLAT				=	"UK3CB_CW_US_B_LATE_LAT";
		_dumbLAT				=	"UK3CB_CW_US_B_LATE_LAT";
		_missileSpecialistAT	= 	"UK3CB_CW_US_B_LATE_AT";
		_missileSpecialistAA	=	"UK3CB_CW_US_B_LATE_AA";
	...
	// Vehicles
		...
		_Mrap					=	"rhsusf_m998_d_4dr";
		_MrapHMG				=	"rhsusf_m1043_d_m2";
		_MrapGMG				=	"rhsusf_m1045_d";
		_cargoTruck				=	"B_Truck_01_flatbed_F";
		_lightIFV				=	"UK3CB_CW_US_B_LATE_M113_M2";
		_lightAA				=	"rhsusf_m113_usarmy_MK19_90";
		_tank					=	"UK3CB_CW_US_B_LATE_M60a3";
		_antiAirAPC				=	"RHS_M6";
		_artilleryAPC			=	"rhsusf_m1a1aimd_usarmy";
		_wheeledIFV				=	"UK3CB_CW_US_B_LATE_LAV25";
		_trackedAPC				=	"RHS_M2A2";
		_tankHunter				=	"UK3CB_CW_US_B_LATE_AAV";
		_smallTrHeli			=	"RHS_MELB_MH6M";
		_mediumTrHeli			=	"RHS_UH60M";
		_largeTrHeli			=	"UK3CB_CW_US_B_LATE_CH47";
		_cargoHeli				=	"UK3CB_CW_US_B_LATE_CH47_Cargo";
		...
		_plane_L2 = switch (true) do {
			...
			case (isClass(configfile >> "CfgVehicles" >> "vn_b_air_f4c_mr")): {"vn_b_air_f4c_mr"};
		...
		_plane_L4 = switch (true) do {
			...
			case (isClass(configfile >> "CfgVehicles" >> "FIR_F15C")): {"FIR_F15C"};
