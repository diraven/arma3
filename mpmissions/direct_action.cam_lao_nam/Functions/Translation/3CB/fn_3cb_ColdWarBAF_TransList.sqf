	...
	// Vehicles
		...
		_smallCargoTruck		=	"UK3CB_BAF_MAN_HX60_Transport_Green_MTP";
		_fuelTruck				=	"UK3CB_BAF_MAN_HX60_Fuel_Green_MTP";
		_car					=	"UK3CB_BAF_LandRover_Snatch_FFR_Green_A_MTP";
		_carHMG					=	"UK3CB_BAF_LandRover_WMIK_GPMG_FFR_Green_A_MTP";
		_carAT					=	"UK3CB_BAF_LandRover_WMIK_Milan_FFR_Green_A_MTP";
		_Mrap					=	"UK3CB_BAF_LandRover_Snatch_FFR_Green_A_MTP";
		_MrapHMG				=	"UK3CB_BAF_LandRover_WMIK_HMG_FFR_Green_A_MTP";
		_MrapGMG				=	"UK3CB_BAF_LandRover_WMIK_GMG_FFR_Green_A_MTP";
		_cargoTruck				=	"UK3CB_BAF_MAN_HX58_Cargo_Green_A_MTP";
		_lightIFV				=	"rhsusf_m113_usarmy_M2_90";
		...
		_artilleryAPC			=	"UK3CB_CW_US_B_EARLY_M109";
		_wheeledIFV				=	"UK3CB_BAF_FV432_Mk3_GPMG_Green_MTP";
		_trackedAPC				=	"UK3CB_BAF_Warrior_A3_W_MTP";
		_tankHunter	 = switch (true) do {
			case (isClass(configfile >> "CfgVehicles" >> "CLV_101")): {"CLV_101"};
			default {"UK3CB_BAF_FV432_Mk3_RWS_Green_MTP"};				
		};
