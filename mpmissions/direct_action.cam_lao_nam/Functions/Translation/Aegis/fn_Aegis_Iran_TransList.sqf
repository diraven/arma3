	...
	// Vehicles
		...
		_quadBike 				=	"O_Quadbike_01_F";
		_smallCargoTruck		=	"O_Truck_02_covered_F";
		_fuelTruck				=	"O_Truck_02_fuel_F";
		...
		_cargoTruck				=	"O_Truck_02_cargo_F";
		_lightIFV				=	"";
		_lightAA				=	"";
		_tank					=	"O_MBT_04_cannon_F";
		...
		_TrPlane				=	"O_Plane_Transport_01_infantry_F";
		_CargoPlane				=	"O_Plane_Transport_01_vehicle_F";
		_plane_L1				=	"";
		_plane_L2				=	"";
		_plane_L3				=	"O_Plane_Fighter_02_Stealth_F";
		_plane_L4				=	"O_Plane_Fighter_02_F";
		_plane_L5				= 	"O_Plane_CAS_02_dynamicLoadout_F";
		_plane_L6				= 	"";
