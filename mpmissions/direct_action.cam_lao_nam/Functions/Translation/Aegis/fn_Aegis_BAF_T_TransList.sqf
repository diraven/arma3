	...
	// Units
		...
		_rifleman				= 	"B_A_Soldier_tna_F";
		_officer 				=	"B_A_Officer_tna_F";
		_teamLeader 			= 	"B_A_Soldier_TL_tna_F";
		_marksman 				= 	"B_A_soldier_M_tna_F";
		_sniper					=	"B_A_ghillie_tna_F";
		_spotter				=	"B_A_ghillie_spotter_tna_F";
		_grenadier				=	"B_A_Soldier_GL_tna_F";
		_autoRifleman			= 	"B_A_Soldier_AR_tna_F";
		_gunner					=	"B_A_HeavyGunner_tna_F";
		_medic					= 	"B_A_Medic_tna_F";
		_repairSpecialist		=	"B_A_Soldier_Repair_tna_F";
		_engineer				= 	"B_A_Engineer_tna_F";
		_guidedLAT				=	"B_A_Soldier_LAT_tna_F";
		_dumbLAT				=	"B_A_Soldier_LAT_tna_F";
		_missileSpecialistAT	= 	"B_A_Soldier_AT_tna_F";
		_missileSpecialistAA	=	"B_A_Soldier_AA_tna_F";
		_ammoBearer				= 	"B_A_Soldier_A_tna_F";
		_JTAC					= 	"B_A_RadioOperator_tna_F";
		_explosivesSpecialist	= 	"B_A_Soldier_Exp_tna_F";
		_uavOperator			= 	"B_A_Soldier_UAV_tna_F";
		_paratrooper			=	"B_A_Soldier_PG_tna_F";
		_heliPilot 				=	"B_A_Helipilot_tna_F";
		_heliCrew				=	"B_A_Helicrew_tna_F";
		_fighterPilot			=	"B_A_Fighter_Pilot_tna_F";
		_pilot					=	"B_A_Pilot_tna_F";
		_vehicleCrew			=  	"B_A_Crew_tna_F";
		_diver 					=	"B_A_Diver_F";
