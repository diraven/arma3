	...
	// Units
		...
		_rifleman				= 	"LIB_US_Rangers_FC_rifleman";
		_officer 				=	"LIB_US_Rangers_captain";
		_teamLeader 			= 	"LIB_US_Rangers_first_lieutenant";
		_marksman 				= 	"LIB_US_Rangers_sniper";
		_sniper					=	"LIB_US_Rangers_sniper";
		_spotter				=	"";
		_grenadier				=	"LIB_US_Rangers_grenadier";
		_autoRifleman			= 	"LIB_US_Rangers_mgunner";
		_gunner					=	"";
		_medic					= 	"LIB_US_Rangers_medic";
		_repairSpecialist		=	"";
		_engineer				= 	"LIB_US_Rangers_engineer";
		_guidedLAT				=	"";
		_dumbLAT				=	"";
		_missileSpecialistAT	= 	"LIB_US_Rangers_AT_soldier";
		_missileSpecialistAA	=	"LIB_US_Rangers_AT_soldier";
		_ammoBearer				= 	"";
		_JTAC					= 	"LIB_US_Rangers_radioman";
