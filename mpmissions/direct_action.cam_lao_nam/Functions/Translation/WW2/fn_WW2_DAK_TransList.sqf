	...
	// Units
		...
		_rifleman				= 	"LIB_DAK_Soldier";
		_officer 				=	"LIB_DAK_Lieutenant";
		_teamLeader 			= 	"LIB_DAK_NCO_2";
		_marksman 				= 	"LIB_DAK_Sniper";
		_sniper					=	"";
		_spotter				=	"";
		_grenadier				=	"LIB_DAK_grenadier";
		_autoRifleman			= 	"LIB_DAK_Soldier_4";
		_gunner					=	"";
		_medic					= 	"LIB_DAK_medic";
		_repairSpecialist		=	"";
		_engineer				= 	"LIB_DAK_sapper";
		_guidedLAT				=	"";
		_dumbLAT				=	"";
		_missileSpecialistAT	= 	"LIB_DAK_AT_soldier";
		_missileSpecialistAA	=	"LIB_DAK_AT_soldier";
		_ammoBearer				= 	"";
		_JTAC					= 	"LIB_DAK_radioman";
