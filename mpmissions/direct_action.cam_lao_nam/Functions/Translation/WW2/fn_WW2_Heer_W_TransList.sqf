	...
	// Units
		...
		_rifleman				= 	"LIB_GER_Rifleman3_w";
		_officer 				=	"LIB_GER_Ober_lieutenant_w";
		_teamLeader 			= 	"LIB_GER_Unterofficer_w";
		_marksman 				= 	"LIB_GER_Scout_sniper_2_w";
		_sniper					=	"";
		_spotter				=	"";
		_grenadier				=	"LIB_GER_ober_grenadier_w";
		_autoRifleman			= 	"LIB_GER_Mgunner_w";
		_gunner					=	"";
		_medic					= 	"LIB_GER_Medic_w";
		_repairSpecialist		=	"";
		_engineer				= 	"LIB_GER_Sapper_w";
		_guidedLAT				=	"LIB_GER_LAT_Rifleman_w";
		_dumbLAT				=	"LIB_GER_LAT_Rifleman_w";
		_missileSpecialistAT	= 	"LIB_GER_AT_soldier_w";
		_missileSpecialistAA	=	"LIB_GER_AT_soldier_w";
		_ammoBearer				= 	"";
		_JTAC					= 	"LIB_GER_Radioman_w";
