	...
	// Units
		...
		_rifleman				= 	"LIB_UK_Para_Rifleman";
		_officer 				=	"LIB_UK_Para_Officer";
		_teamLeader 			= 	"LIB_UK_Para_Sergeant";
		_marksman 				= 	"LIB_UK_Para_Sniper";
		_sniper					=	"";
		_spotter				=	"";
		_grenadier				=	"LIB_UK_Para_Grenadier";
		_autoRifleman			= 	"LIB_UK_Para_LanceCorporal";
		_gunner					=	"";
		_medic					= 	"LIB_UK_Para_Medic";
		_repairSpecialist		=	"";
		_engineer				= 	"LIB_UK_Para_Engineer";
		_guidedLAT				=	"";
		_dumbLAT				=	"";
		_missileSpecialistAT	= 	"LIB_UK_Para_AT_Soldier";
		_missileSpecialistAA	=	"LIB_UK_Para_AT_Soldier";
		_ammoBearer				= 	"";
		_JTAC					= 	"LIB_UK_Para_Radioman";
