	...
	// Units
		...
		_rifleman				= 	"fow_s_us_p_rifleman";
		_officer 				=	"fow_s_us_p_officer";
		_teamLeader 			= 	"fow_s_us_p_nco";
		_marksman 				= 	"fow_s_us_p_sniper_m1903a1";
		_sniper					=	"";
		_spotter				=	"fow_s_us_p_rifleman_scout";
		_grenadier				=	"fow_s_us_p_rifleman_gl";
		_autoRifleman			= 	"fow_s_us_p_bar_gunner";
		_gunner					=	"fow_s_us_p_m1919a6_gunner";
		_medic					= 	"fow_s_us_p_medic";
		_repairSpecialist		=	"";
		_engineer				= 	"fow_s_us_p_engineer";
		_guidedLAT				=	"";
		_dumbLAT				=	"";
		_missileSpecialistAT	= 	"fow_s_us_p_at";
		_missileSpecialistAA	=	"fow_s_us_p_at";
		_ammoBearer				= 	"";
		_JTAC					= 	"fow_s_us_p_radio_operator";
