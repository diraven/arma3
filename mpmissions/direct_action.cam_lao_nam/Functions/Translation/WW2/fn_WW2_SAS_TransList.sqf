	...
	// Units
		...
		_rifleman				= 	"fow_s_uk_cdo_rifleman";
		_officer 				=	"fow_s_uk_cdo_officer";
		_teamLeader 			= 	"fow_s_uk_cdo_teamleader";
		_marksman 				= 	"LIB_UK_DR_Sniper";
		_sniper					=	"";
		_spotter				=	"";
		_grenadier				=	"LIB_UK_DR_Grenadier";
		_autoRifleman			= 	"fow_s_uk_cdo_bren_gunner";
		_gunner					=	"";
		_medic					= 	"fow_s_uk_cdo_medic";
		_repairSpecialist		=	"";
		_engineer				= 	"fow_s_uk_cdo_at";
		_guidedLAT				=	"";
		_dumbLAT				=	"";
		_missileSpecialistAT	= 	"fow_s_uk_cdo_at";
		_missileSpecialistAA	=	"fow_s_uk_cdo_at";
		_ammoBearer				= 	"";
		_JTAC					= 	"fow_s_uk_cdo_radio_operator";
