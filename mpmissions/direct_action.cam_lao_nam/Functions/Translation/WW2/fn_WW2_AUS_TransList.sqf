	...
	// Units
		...
		_rifleman				= 	"fow_s_aus_rifleman";
		_officer 				=	"fow_s_aus_officer_l";
		_teamLeader 			= 	"fow_s_aus_teamleader_l";
		_marksman 				= 	"fow_s_aus_rifleman_l";
		_sniper					=	"";
		_spotter				=	"";
		_grenadier				=	"fow_s_aus_section_commander";
		_autoRifleman			= 	"fow_s_aus_bren_gunner_l";
		_gunner					=	"";
		_medic					= 	"fow_s_aus_medic_l";
		_repairSpecialist		=	"";
		_engineer				= 	"fow_s_aus_at_l";
		_guidedLAT				=	"";
		_dumbLAT				=	"";
		_missileSpecialistAT	= 	"fow_s_aus_at";
		_missileSpecialistAA	=	"fow_s_aus_at";
		_ammoBearer				= 	"fow_s_aus_bren_asst_l";
		_JTAC					= 	"fow_s_aus_section_commander_l";
