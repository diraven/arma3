	...
	// Units
		...
		_rifleman				= 	"LIB_GER_rifleman";
		_officer 				=	"LIB_GER_ober_lieutenant";
		_teamLeader 			= 	"LIB_GER_unterofficer";
		_marksman 				= 	"LIB_GER_scout_sniper";
		_sniper					=	"";
		_spotter				=	"";
		_grenadier				=	"LIB_GER_ober_grenadier";
		_autoRifleman			= 	"LIB_GER_mgunner";
		_gunner					=	"";
		_medic					= 	"LIB_GER_medic";
		_repairSpecialist		=	"";
		_engineer				= 	"LIB_GER_sapper";
		_guidedLAT				=	"";
		_dumbLAT				=	"";
		_missileSpecialistAT	= 	"LIB_GER_AT_soldier";
		_missileSpecialistAA	=	"";
		_ammoBearer				= 	"";
		_JTAC					= 	"LIB_GER_radioman";
