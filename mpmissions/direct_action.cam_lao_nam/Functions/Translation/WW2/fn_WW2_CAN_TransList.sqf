	...
	// Units
		...
		_rifleman				= 	"fow_s_uk_can_01_rifleman";
		_officer 				=	"fow_s_uk_can_01_officer";
		_teamLeader 			= 	"fow_s_uk_can_01_teamleader";
		_marksman 				= 	"fow_s_uk_can_02_rifleman";
		_sniper					=	"";
		_spotter				=	"";
		_grenadier				=	"fow_s_uk_can_01_section_commander";
		_autoRifleman			= 	"fow_s_uk_can_01_bren_gunner";
		_gunner					=	"";
		_medic					= 	"fow_s_uk_can_01_medic";
		_repairSpecialist		=	"";
		_engineer				= 	"fow_s_uk_can_02_at";
		_guidedLAT				=	"";
		_dumbLAT				=	"";
		_missileSpecialistAT	= 	"fow_s_uk_can_01_at";
		_missileSpecialistAA	=	"fow_s_uk_can_01_at";
		_ammoBearer				= 	"fow_s_uk_can_01_bren_asst";
		_JTAC					= 	"fow_s_uk_can_01_radio_operator";
