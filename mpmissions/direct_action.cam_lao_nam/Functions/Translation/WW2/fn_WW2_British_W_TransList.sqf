	...
	// Units
		...
		_rifleman				= 	"LIB_UK_Rifleman";
		_officer 				=	"LIB_UK_Officer";
		_teamLeader 			= 	"LIB_UK_Sergeant";
		_marksman 				= 	"LIB_UK_Sniper";
		_sniper					=	"";
		_spotter				=	"";
		_grenadier				=	"LIB_UK_Grenadier";
		_autoRifleman			= 	"LIB_UK_LanceCorporal";
		_gunner					=	"";
		_medic					= 	"LIB_UK_Medic";
		_repairSpecialist		=	"";
		_engineer				= 	"LIB_UK_Engineer";
		_guidedLAT				=	"";
		_dumbLAT				=	"";
		_missileSpecialistAT	= 	"LIB_UK_AT_Soldier";
		_missileSpecialistAA	=	"LIB_UK_AT_Soldier";
		_ammoBearer				= 	"";
		_JTAC					= 	"fow_s_uk_radio_operator";
