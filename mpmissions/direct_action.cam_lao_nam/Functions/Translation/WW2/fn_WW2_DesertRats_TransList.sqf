	...
	// Units
		...
		_rifleman				= 	"LIB_UK_DR_Rifleman";
		_officer 				=	"LIB_UK_DR_Officer";
		_teamLeader 			= 	"LIB_UK_DR_Sergeant";
		_marksman 				= 	"LIB_UK_DR_Sniper";
		_sniper					=	"";
		_spotter				=	"";
		_grenadier				=	"LIB_UK_DR_Grenadier";
		_autoRifleman			= 	"LIB_UK_DR_LanceCorporal";
		_gunner					=	"";
		_medic					= 	"LIB_UK_DR_Medic";
		_repairSpecialist		=	"";
		_engineer				= 	"LIB_UK_DR_Engineer";
		_guidedLAT				=	"";
		_dumbLAT				=	"";
		_missileSpecialistAT	= 	"LIB_UK_DR_AT_Soldier";
		_missileSpecialistAA	=	"LIB_UK_DR_AT_Soldier";
		_ammoBearer				= 	"";
		_JTAC					= 	"LIB_UK_DR_Radioman";
		...
		_pilot					=	"LIB_US_Pilot";
		_vehicleCrew			=  	"LIB_UK_DR_Tank_Crew";
		_diver 					=	"";
		_diverTeamLeader		=	"";
		_diverExplosives		=	"";
