	...
	// Units
		...
		_rifleman				= 	"LIB_FSJ_Soldier";
		_officer 				=	"LIB_FSJ_Lieutenant";
		_teamLeader 			= 	"LIB_FSJ_NCO";
		_marksman 				= 	"LIB_FSJ_Sniper";
		_sniper					=	"";
		_spotter				=	"";
		_grenadier				=	"LIB_FSJ_LAT_Soldier";
		_autoRifleman			= 	"LIB_FSJ_Mgunner";
		_gunner					=	"";
		_medic					= 	"LIB_FSJ_medic";
		_repairSpecialist		=	"";
		_engineer				= 	"LIB_FSJ_sapper";
		_guidedLAT				=	"LIB_FSJ_LAT_Soldier";
		_dumbLAT				=	"LIB_FSJ_LAT_Soldier";
		_missileSpecialistAT	= 	"LIB_FSJ_AT_soldier";
		_missileSpecialistAA	=	"LIB_FSJ_AT_soldier";
		_ammoBearer				= 	"";
		_JTAC					= 	"LIB_FSJ_radioman";
