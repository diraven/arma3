	...
	// Units
		...
		_rifleman				= 	"Roman_legioner_troop_IMS_red";
		_officer 				=	"Roman_legioner_cent_red";
		_teamLeader 			= 	"Roman_legioner_cent_IMS_red";
		_marksman 				= 	"Roman_auxia_archer_red";
		_sniper					=	"Roman_auxia_archer_red";
		_spotter				=	"B_spotter_F";
		_grenadier				=	"Roman_legioner_evoc_IMS_red";
		_autoRifleman			= 	"Roman_legioner_pilum_red";
		_gunner					=	"B_HeavyGunner_F";
		_medic					= 	"Roman_legioner_aquila_red";
		_repairSpecialist		=	"B_soldier_repair_F";
		_engineer				= 	"Roman_auxia_troop_IMS_red";
		_guidedLAT				=	"B_soldier_LAT_F";
		_dumbLAT				=	"B_soldier_LAT2_F";
		_missileSpecialistAT	= 	"Roman_auxia_spear_IMS_red";
		_missileSpecialistAA	=	"Roman_auxia_spear_IMS_red";
		_ammoBearer				= 	"B_Soldier_A_F";
		_JTAC					= 	"Roman_legioner_sign_red";
		_explosivesSpecialist	= 	"B_soldier_exp_F";
		_uavOperator			= 	"Roman_legioner_troopL_IMS_red";
