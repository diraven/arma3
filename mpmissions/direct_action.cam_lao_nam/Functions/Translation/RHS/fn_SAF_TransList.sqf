	...
	// Units
		...
		_rifleman				=	"rhssaf_army_m10_para_rifleman_g36";
		_officer 				=	"rhssaf_army_m10_para_officer";
		_teamLeader 			= 	"rhssaf_army_m10_para_sq_lead";
		_marksman 				= 	"rhssaf_army_m10_para_sniper_m76";
		...
		_JTAC					= 	"rhssaf_army_m10_para_spotter";
		_explosivesSpecialist	= 	"rhssaf_army_m10_para_exp";
		_uavOperator			= 	"rhssaf_army_m10_para_ft_lead";
		_paratrooper			=	"";
