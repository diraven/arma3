		...
		_arsenalHeadgear = [	
			...
			'H_ACR_A3_HelmetIA_Headset_vz95_des',
			'H_ACR_A3_HelmetIA_Goggles_vz95_des',
			'H_ACR_A3_HelmetIA_Goggles_Headset_vz95_des',
			'H_ACR_A3_HelmetB_des',
			'H_ACR_A3_Booniehat_vz95_des',
			'H_ACR_A3_Cap_Headphones_des',
			'H_ACR_A3_Booniehat_fold_des',
			'H_ACR_A3_HelmetB_des_Goggles',
		...
		_arsenalUniforms = [
			...
			'U_ACR_A3_CombatUniform_Des',
			'U_ACR_A3_CombatUniform_Des_tshirt',
			'U_ACR_A3_CombatUniform_Des_vest',
			'U_ACR_A3_HeliPilotCoveralls_khk',
			'U_ACR_A3_OfficerUniform_des',
			'U_ACR_A3_SweaterUniform_des',
		...
		_arsenalVests = [
			...
			'V_ACR_A3_NPP2006_vz95_des',
			'V_ACR_A3_NPP2006_ok_des',
			'V_ACR_A3_NPP2006_nk_des',
			'V_ACR_A3_NPP2006_co_des',
			'V_ACR_A3_PlateCarrier1_khk',
			'V_ACR_A3_PlateCarrier2_khk',
