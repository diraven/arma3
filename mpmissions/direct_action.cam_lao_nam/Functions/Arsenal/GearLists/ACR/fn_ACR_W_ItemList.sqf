		...
		_arsenalHeadgear = [	
			...
			'H_ACR_A3_HelmetIA_vz95',
			'H_ACR_A3_HelmetIA_Headset_vz95',
			'H_ACR_A3_HelmetIA_Goggles_vz95',
			'H_ACR_A3_HelmetIA_Goggles_Headset_vz95',
			'H_ACR_A3_HelmetB_rgr',
			'H_ACR_A3_Booniehat_vz95',
			'H_ACR_A3_Booniehat_fold_vz95',
			'H_ACR_A3_HelmetB_ECH_rgr',
			'H_ACR_A3_HelmetB_rgl_Goggles',			
			'H_ACR_A3_Patrol_Cap',
		...
		_arsenalUniforms = [
			...
			'U_ACR_A3_CombatUniform',
			'U_ACR_A3_CombatUniform_tshirt',
			'U_ACR_A3_CombatUniform_vest',
			'U_ACR_A3_HeliPilotCoveralls_rgr',
			'U_ACR_A3_OfficerUniform_vz95',			
			'U_ACR_A3_SweaterUniform_vz95',
		...
		_arsenalVests = [
			...
			'V_ACR_A3_NPP2006_vz95',
			'V_ACR_A3_NPP2006_light_vz95',
			'V_ACR_A3_NPP2006_ok_vz95',
			'V_ACR_A3_NPP2006_nk_vz95',
			'V_ACR_A3_NPP2006_co_vz95',
			'V_ACR_A3_PlateCarrier1_rgr',
			'V_ACR_A3_PlateCarrier2_rgr',
		...
		_arsenalBackpacks = [
			...
			'ACR_A3_ACRPara_m95',
			'ACR_A3_ACRScout_m95',
			'ACR_A3_Backpack_Carryall_vz95',
			'ACR_A3_Backpack_Kitbag_vz95',
			'ACR_A3_B_AssaultPack_vz95',
			'ACR_A3_B_AssaultPack_rgr_LAT',
			'ACR_A3_B_AssaultPack_vz95_ammo',
			'ACR_A3_B_Kitbag_vz95_tool',
			'ACR_A3_B_Kitbag_vz95_exp',
			'ACR_A3_B_Carryall_vz95_ammo',
			
			'ACR_A3_ACRPara_Base',
			'ACR_A3_ACRPara_m95',
			'ACR_A3_ACRScout_Base',
			'ACR_A3_ACRScout_m95',
			'ACR_A3_Backpack_Carryall_vz95',
			'ACR_A3_Backpack_Kitbag_vz95',
			'ACR_A3_B_AssaultPack_vz95',
