	...
	if (!(_worldName == (toUpper "cup_chernarus_A3"))) exitWith {};
		...
		switch (true) do {
			...
			// WW2 Setup
				...
				case (WW2_Running and BEW_v_WW2 and !(forceVanilla))	:	{
					...
					bluFaction			=	"WW2_Heer";			// Main Blufor Faction
					blu_AltFaction		=	"WW2_Heer";			// Alt Blufor Faction (Unused)
					blu_SofFaction		=	"WW2_FSJ";			// Blufor SOF Faction
					opf_1Faction		=	"WW2_Soviet";		// Main Opfor Faction 1
					opf_2Faction		=	"WW2_Soviet";		// Main Opfor Faction 2
					opf_SOFFaction		=	"WW2_Soviet";		// Opfor SOF Faction
					ind_1Faction		=	"WW2_PanzerLehr";	// Main Independant Faction 1
					ind_2Faction		=	"WW2_Heer";			// Main Independant Faction 2
					rebel_1Faction		=	"WW2_Heer";			// Rebel Faction 1
					rebel_2Faction		=	"WW2_Heer";			// Rebel Faction 2
