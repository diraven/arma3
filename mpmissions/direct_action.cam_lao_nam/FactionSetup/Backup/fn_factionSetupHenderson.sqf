	...
	if (!(_worldName == (toUpper "fow_map_henderson"))) exitWith {};
		...
		switch (true) do {
			...
			// WW2 Setup
				...
				case (WW2_Running and BEW_v_WW2 and !(forceVanilla))	:	{
					...
					bluFaction			=	"WW2_USNavy";	// Main Blufor Faction
					blu_AltFaction		=	"WW2_USNavy";	// Alt Blufor Faction (Unused)
					blu_SofFaction		=	"WW2_USNavy";	// Blufor SOF Faction
					opf_1Faction		=	"WW2_Japan";	// Main Opfor Faction 1
					opf_2Faction		=	"WW2_Japan";	// Main Opfor Faction 2
					opf_SOFFaction		=	"WW2_Japan";	// Opfor SOF Faction
					ind_1Faction		=	"WW2_AUS";		// Main Independant Faction 1
					ind_2Faction		=	"WW2_USNavy";	// Main Independant Faction 2
					rebel_1Faction		=	"WW2_USNavy";	// Rebel Faction 1
					rebel_2Faction		=	"WW2_USNavy";	// Rebel Faction 2
