	...
	if (!(_worldName == (toUpper "Tanoa"))) exitWith {};
		...
		switch (true) do {
			...
			// Default Vanilla Setup
				...
				case ((!BEW_v_RHS_Running and !(BEW_v_CUP_Running) and !(BEW_v_GM_Running) and !(BEW_v_VN_Running) and !(BEW_v_Aegis_Running) and !(BEW_v_OPTRE_Running) and !(WW2_Running) and !(isClass(configfile >> "CfgMods" >> "SWOP_MODs"))) or (forceVanilla))	:	{
					...
					bluFaction				=	"NATO_T";			// Main Blufor Faction
			...
			// RHS Setup
				...
				case (BEW_v_RHS_Running and !(forceVanilla))	:	{
					...
					blu_AltFaction			=	"SOCOM_W";			// Alt Blufor Faction (Unused)
					...
					ind_1Faction			=	"USMCW";			// Main Independant Faction 1
					ind_2Faction			=	"USNavy";			// Main Independant Faction 2
			...
			// WW2 Setup
				...
				case (WW2_Running and !(forceVanilla))	:	{

					bluFaction			=	"WW2_USArmy";		// Main Blufor Faction
					blu_AltFaction		=	"WW2_USNavy";		// Alt Blufor Faction (Unused)
					blu_SofFaction		=	"WW2_USRangers";	// Blufor SOF Faction
					opf_1Faction		=	"WW2_Heer";			// Main Opfor Faction 1
					opf_2Faction		=	"WW2_Heer";			// Main Opfor Faction 2
					opf_SOFFaction		=	"WW2_Heer";			// Opfor SOF Faction
					ind_1Faction		=	"WW2_British";		// Main Independant Faction 1
