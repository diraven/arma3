	...
	if (!(_worldName == (toUpper "tem_anizay"))) exitWith {};
		...
		switch (true) do {
			...
			// Default Vanilla Setup
				...
				case ((!BEW_v_RHS_Running and !(BEW_v_CUP_Running) and !(BEW_v_GM_Running) and !(BEW_v_VN_Running) and !(BEW_v_Aegis_Running) and !(BEW_v_OPTRE_Running) and !(WW2_Running) and !(isClass(configfile >> "CfgMods" >> "SWOP_MODs"))) or (forceVanilla))	:	{
					...
					opf_1Faction			=	"CSAT";				// Main Opfor Faction 1
					opf_2Faction			=	"OPF_FIA";			// Main Opfor Faction 2
					opf_3Faction			= 	"";
			...
			// RHS Setup
				...
				case (BEW_v_RHS_Running and !(forceVanilla))	:	{
					...
					blu_AltFaction			=	"USMCD";			// Alt Blufor Faction (Unused)
					blu_SofFaction			=	"USMCD";			// Blufor SOF Faction
					opf_1Faction			=	"VDV_D";			// Main Opfor Faction 1
					opf_2Faction			=	"VDV_D";			// Main Opfor Faction 2
					opf_3Faction			= 	"";
					opf_SOFFaction			=	"VDV_D";			// Opfor SOF Faction
					ind_1Faction			=	"SOCOM_D";			// Main Independant Faction 1
					ind_2Faction			=	"USMCD";			// Main Independant Faction 2
					rebel_1Faction			=	"USMCD";			// Rebel Faction 1
					rebel_2Faction			=	"USMCD";			// Rebel Faction 2
		...
		// Opposition Star Wars Setup
			...
			// WW2 Setup
				...
				case (WW2_Running and BEW_v_WW2 and !(forceVanilla))	:	{
					...
					bluFaction			=	"WW2_DesertRats";	// Main Blufor Faction
					blu_AltFaction		=	"WW2_USNavy";		// Alt Blufor Faction (Unused)
					blu_SofFaction		=	"WW2_SAS";			// Blufor SOF Faction
					opf_1Faction		=	"WW2_DAK";			// Main Opfor Faction 1
					opf_2Faction		=	"WW2_DAK";			// Main Opfor Faction 2
					opf_3Faction		= 	"";
					opf_SOFFaction		=	"WW2_FSJ_DAK";		// Opfor SOF Faction
					ind_1Faction		=	"WW2_USArmy_D";		// Main Independant Faction 1
					ind_2Faction		=	"WW2_USNavy";		// Main Independant Faction 2
					rebel_1Faction		=	"WW2_USRangers";	// Rebel Faction 1
					rebel_2Faction		=	"WW2_USArmy";		// Rebel Faction 2
	...
	// Multi Mod Presets
			...
			if (BEW_v_RHS_Running and BEW_v_3CB_Factions_Running and !(forceVanilla) and (BEW_v_ColdWar)) then {
				...
				// Cold War + 3CB BAF
					...
					if (BEW_v_3CB_BAF_Running) then {
						...
						blu_AltFaction			=	"3CB_ColdWarBAF_D";
		...
		// Zombies
			...
			if (BEW_v_Zombies) then {
				...
				opf_1Faction			=	"Zombies";		
				opf_2Faction			=	"Zombies";
				opf_3Faction			=	"Zombies";
