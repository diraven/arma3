...
// ADDITIONAL FACTIONS
	...
	// British Army
		...
		// Ukraine Army
			...
			if (UKR_Running and BEW_v_RHS_Running and !(BEW_v_ForceVanilla)) then {

				_UKR_Factions = ["UKRArmy"];		
				
				if !(bluFaction in _UKR_Factions) then {
					...
					BEW_v_modPresetString = BEW_v_modPresetString + "_UKR";
