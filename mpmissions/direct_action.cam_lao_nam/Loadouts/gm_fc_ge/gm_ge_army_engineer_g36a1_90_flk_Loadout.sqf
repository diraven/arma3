...
_obj addWeapon "gm_pzf84_oli";
_obj addSecondaryWeaponItem "gm_feroz2x17_pzf84_blk";
_obj addSecondaryWeaponItem "gm_1Rnd_84x245mm_heat_t_DM32_carlgustaf";
_obj addWeapon "gm_p1_blk";
_obj addHandgunItem "gm_8Rnd_9x19mm_B_DM11_p1_blk";

comment "Add containers";
_obj forceAddUniform "gm_ge_uniform_soldier_90_flk";
_obj addVest "gm_ge_vest_90_rifleman_flk";
_obj addBackpack "gm_ge_army_backpack_90_flk";
...
_obj addItemToBackpack "gm_1Rnd_84x245mm_heat_t_DM32_carlgustaf";
_obj addHeadgear "gm_ge_headgear_m92_flk";
