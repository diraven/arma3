...
for "_i" from 1 to 5 do {_obj addItemToUniform "FirstAidKit";};
for "_i" from 1 to 2 do {_obj addItemToUniform "LIB_6Rnd_455";};
_obj addItemToVest "LIB_ACC_No4_Mk2_Bayo";
_obj addItemToVest "fow_e_no36mk1";
_obj addItemToVest "fow_e_no77";
for "_i" from 1 to 11 do {_obj addItemToVest "LIB_10Rnd_770x56";};
