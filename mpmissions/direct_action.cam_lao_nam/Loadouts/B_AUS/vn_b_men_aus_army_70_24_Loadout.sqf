...
comment "Add weapons";
_obj addWeapon "vn_f1_smg";
_obj addPrimaryWeaponItem "vn_f1_smg_mag";
_obj addWeapon "vn_hp";
_obj addHandgunItem "vn_hp_mag";

comment "Add containers";
_obj forceAddUniform "vn_b_uniform_aus_01_01";
_obj addVest "vn_b_vest_usarmy_11";
...
_obj addItemToUniform "vn_hp_mag";
for "_i" from 1 to 5 do {_obj addItemToVest "vn_f1_smg_mag";};
