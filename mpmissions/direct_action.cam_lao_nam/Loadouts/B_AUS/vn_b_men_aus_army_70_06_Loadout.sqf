...
comment "Add weapons";
_obj addWeapon "vn_l2a1_01";
_obj addPrimaryWeaponItem "vn_l1a1_30_02_t_mag";
...
_obj addBackpack "vn_b_pack_pfield_01_l1a1_pl";
...
for "_i" from 1 to 5 do {_obj addItemToVest "vn_l1a1_30_02_t_mag";};
for "_i" from 1 to 5 do {_obj addItemToBackpack "vn_l1a1_30_02_t_mag";};
