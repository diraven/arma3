...
comment "Add weapons";
_obj addWeapon "vn_l1a1_03_camo";
_obj addPrimaryWeaponItem "vn_l1a1_20_t_mag";
_obj addWeapon "vn_rpg7";
_obj addSecondaryWeaponItem "vn_rpg7_mag";
...
for "_i" from 1 to 5 do {_obj addItemToBackpack "vn_rpg7_mag";};
_obj addHeadgear "vn_b_boonie_02_08";
