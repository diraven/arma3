...
comment "Add weapons";
_obj addWeapon "vn_m60_shorty_camo";
...
for "_i" from 1 to 2 do {_obj addItemToVest "vn_m60_100_mag";};
for "_i" from 1 to 3 do {_obj addItemToBackpack "vn_m60_100_mag";};
_obj addHeadgear "vn_b_bandana_08";
