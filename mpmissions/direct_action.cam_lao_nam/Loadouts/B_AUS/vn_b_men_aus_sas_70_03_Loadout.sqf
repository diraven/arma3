...
comment "Add weapons";
_obj addWeapon "vn_m14_camo";
_obj addPrimaryWeaponItem "vn_o_9x_m14";
_obj addPrimaryWeaponItem "vn_m14_mag";
_obj addWeapon "vn_hp";
_obj addHandgunItem "vn_hp_mag";

comment "Add containers";
_obj forceAddUniform "vn_b_uniform_sas_01_06";
_obj addVest "vn_b_vest_sas_01";
_obj addBackpack "vn_b_pack_p44_01";
...
for "_i" from 1 to 2 do {_obj addItemToVest "vn_hp_mag";};
for "_i" from 1 to 7 do {_obj addItemToVest "vn_m14_mag";};
for "_i" from 1 to 2 do {_obj addItemToBackpack "vn_mine_satchel_remote_02_mag";};
_obj addHeadgear "vn_b_boonie_04_08";
