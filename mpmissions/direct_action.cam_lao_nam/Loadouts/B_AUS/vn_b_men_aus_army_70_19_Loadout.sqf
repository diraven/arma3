...
comment "Add weapons";
_obj addWeapon "vn_m40a1";
_obj addPrimaryWeaponItem "vn_o_9x_m40a1";
_obj addPrimaryWeaponItem "vn_m40a1_mag";
_obj addWeapon "vn_hp";
_obj addHandgunItem "vn_hp_mag";

comment "Add containers";
_obj forceAddUniform "vn_b_uniform_aus_04_01";
_obj addVest "vn_b_vest_anzac_03";
...
for "_i" from 1 to 2 do {_obj addItemToUniform "vn_m67_grenade_mag";};
for "_i" from 1 to 10 do {_obj addItemToVest "vn_m40a1_mag";};
...
_obj addHeadgear "vn_b_boonie_08_01";
