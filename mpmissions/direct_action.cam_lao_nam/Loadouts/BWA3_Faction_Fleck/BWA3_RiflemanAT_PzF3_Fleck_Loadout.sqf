...
_obj addWeapon "BWA3_PzF3";
_obj addSecondaryWeaponItem "BWA3_PzF3_Tandem";
...
_obj addBackpack "BWA3_Carryall_Fleck";
...
for "_i" from 1 to 7 do {_obj addItemToBackpack "BWA3_PzF3_Tandem";};
