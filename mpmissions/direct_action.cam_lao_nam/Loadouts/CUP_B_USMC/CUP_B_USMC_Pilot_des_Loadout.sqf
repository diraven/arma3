...
_obj addWeapon "CUP_hgun_Colt1911";
_obj addHandgunItem "CUP_7Rnd_45ACP_1911";

comment "Add containers";
_obj forceAddUniform "CUP_U_B_USArmy_PilotOverall";
_obj addVest "CUP_V_B_PilotVest";
_obj addBackpack "B_LegStrapBag_black_F";

comment "Add items to containers";
for "_i" from 1 to 3 do {_obj addItemToUniform "FirstAidKit";};
for "_i" from 1 to 2 do {_obj addItemToUniform "CUP_7Rnd_45ACP_1911";};
