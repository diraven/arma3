...
_obj addBackpack "Japan_JP_Jeitai_Carryall";
...
for "_i" from 1 to 2 do {_obj addItemToBackpack "rhs_fim92_mag";};
...
[_obj,"AsianHead_A3_01","male02chi"] call BIS_fnc_setIdentity;
