...
_obj addBackpack "UK3CB_BAF_B_Bergen_OLI_Rifleman_B";
...
for "_i" from 1 to 10 do {_obj addItemToBackpack "UK3CB_BAF_556_30Rnd_T";};
_obj addHeadgear "UK3CB_BAF_H_Mk6_DPMW_B";
