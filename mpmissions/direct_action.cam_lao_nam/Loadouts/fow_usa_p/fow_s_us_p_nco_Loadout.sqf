...
_obj addVest "fow_v_usmc_thompson_nco";
...
for "_i" from 1 to 2 do {_obj addItemToUniform "LIB_30Rnd_45ACP";};
for "_i" from 1 to 4 do {_obj addItemToVest "LIB_30Rnd_45ACP";};
for "_i" from 1 to 2 do {_obj addItemToVest "LIB_7Rnd_45ACP";};
_obj addItemToBackpack "LIB_US_TNT_4pound_mag";
for "_i" from 1 to 2 do {_obj addItemToBackpack "fow_e_no77";};
_obj addItemToBackpack "fow_e_mk2";
