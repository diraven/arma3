...
comment "Add weapons";
_obj addWeapon "gm_lmgm62_blk";
_obj addPrimaryWeaponItem "gm_120Rnd_762x51mm_B_T_DM21_mg3_grn";
...
for "_i" from 1 to 4 do {_obj addItemToBackpack "gm_120Rnd_762x51mm_B_T_DM21_mg3_grn";};
