...
_obj addWeapon "uns_m20_bazooka";
_obj addSecondaryWeaponItem "uns_M28A2_mag";
...
for "_i" from 1 to 7 do {_obj addItemToVest "vn_m16_20_t_mag";};
for "_i" from 1 to 3 do {_obj addItemToBackpack "uns_M28A2_mag";};
