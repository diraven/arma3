...
_obj addVest "fow_v_us_ab_thompson_nco";
...
for "_i" from 1 to 4 do {_obj addItemToUniform "LIB_30Rnd_45ACP";};
_obj addItemToVest "fow_e_mk2";
for "_i" from 1 to 2 do {_obj addItemToVest "fow_e_no77";};
for "_i" from 1 to 3 do {_obj addItemToVest "LIB_30Rnd_45ACP";};
