...
comment "Add weapons";
_obj addWeapon "LIB_M1918A2_BAR";
_obj addPrimaryWeaponItem "LIB_M1918A2_BAR_Handle";
_obj addPrimaryWeaponItem "LIB_20Rnd_762x63";
_obj addPrimaryWeaponItem "LIB_M1918A2_BAR_Bipod";
_obj addWeapon "LIB_Colt_M1911";
_obj addHandgunItem "LIB_7Rnd_45ACP";

comment "Add containers";
_obj forceAddUniform "fow_u_us_hbt_01_private";
_obj addVest "fow_v_us_bar";
...
for "_i" from 1 to 8 do {_obj addItemToVest "LIB_20Rnd_762x63";};
