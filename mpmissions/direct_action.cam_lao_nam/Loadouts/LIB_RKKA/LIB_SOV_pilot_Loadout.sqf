...
_obj forceAddUniform "U_LIB_SOV_Pilot";
...
for "_i" from 1 to 4 do {_obj addItemToVest "fow_20Rnd_45acp";};
_obj addItemToBackpack "LIB_ToolKit";
_obj addHeadgear "H_LIB_SOV_PilotHelmet";
_obj addGoggles "G_LIB_Dust_Goggles";
