...
comment "Add weapons";
_obj addWeapon "LIB_SVT_40";
_obj addPrimaryWeaponItem "LIB_10Rnd_762x54";
_obj addWeapon "LIB_TT33";
_obj addHandgunItem "LIB_8Rnd_762x25";

comment "Add containers";
_obj forceAddUniform "U_LIB_SOV_Strelok_summer";
_obj addVest "V_LIB_SOV_RA_SVTBelt";
_obj addBackpack "B_LIB_SOV_RA_Radio";
...
for "_i" from 1 to 8 do {_obj addItemToVest "LIB_10Rnd_762x54";};
