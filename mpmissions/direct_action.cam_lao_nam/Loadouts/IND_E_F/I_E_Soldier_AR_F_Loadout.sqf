...
comment "Add weapons";
_obj addWeapon "LMG_Mk200_black_F";
...
_obj addBackpack "B_AssaultPack_eaf_F";
...
_obj addItemToVest "200Rnd_65x39_cased_Box_Tracer_Red";
for "_i" from 1 to 2 do {_obj addItemToBackpack "200Rnd_65x39_cased_Box_Tracer_Red";};
