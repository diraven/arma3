...
_obj addPrimaryWeaponItem "30Rnd_762x39_Mag_Tracer_Green_F";
_obj addWeapon "hgun_ACPC2_F";
_obj addHandgunItem "9Rnd_45ACP_Mag";

comment "Add containers";
_obj forceAddUniform "U_IG_Guerilla1_1";
_obj addVest "V_Chestrig_oli";
_obj addBackpack "B_AssaultPack_khk";
...
for "_i" from 1 to 10 do {_obj addItemToVest "30Rnd_762x39_Mag_Tracer_Green_F";};
