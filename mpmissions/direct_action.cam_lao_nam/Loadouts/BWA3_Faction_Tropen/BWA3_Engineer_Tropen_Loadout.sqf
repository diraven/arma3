...
_obj addWeapon "BWA3_RGW90";
_obj addSecondaryWeaponItem "BWA3_RGW90_HH";
...
_obj addBackpack "BWA3_Kitbag_Tropen";
...
for "_i" from 1 to 2 do {_obj addItemToBackpack "BWA3_RGW90_HH";};
