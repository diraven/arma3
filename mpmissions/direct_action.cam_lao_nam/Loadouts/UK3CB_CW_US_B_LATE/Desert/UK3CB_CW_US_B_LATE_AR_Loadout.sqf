...
comment "Add weapons";
_obj addWeapon "rhs_weap_m249_pip";
...
_obj addVest "UK3CB_CW_US_B_LATE_V_PASGT_MG_Vest";
...
for "_i" from 1 to 2 do {_obj addItemToVest "rhsusf_200rnd_556x45_mixed_box";};
