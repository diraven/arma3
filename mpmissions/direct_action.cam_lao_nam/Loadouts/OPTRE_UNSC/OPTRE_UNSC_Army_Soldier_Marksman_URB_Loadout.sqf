...
comment "Add weapons";
_obj addWeapon "OPTRE_BR55";
_obj addPrimaryWeaponItem "OPTRE_BR55HB_Scope";
_obj addPrimaryWeaponItem "OPTRE_36Rnd_95x40_Mag";
...
_obj addVest "OPTRE_UNSC_M52D_Armor_Marksman";
...
for "_i" from 1 to 9 do {_obj addItemToVest "OPTRE_36Rnd_95x40_Mag";};
