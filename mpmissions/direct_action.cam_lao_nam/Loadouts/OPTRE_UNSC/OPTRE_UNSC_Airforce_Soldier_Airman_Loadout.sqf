...
_obj forceAddUniform "OPTRE_UNSC_Airforce_Uniform_R";
_obj addVest "OPTRE_UNSC_M52A_Armor4_URB";
...
for "_i" from 1 to 10 do {_obj addItemToVest "OPTRE_60Rnd_5x23mm_Mag";};
for "_i" from 1 to 2 do {_obj addItemToVest "SmokeShell";};
_obj addItemToVest "SmokeShellRed";
_obj addItemToVest "SmokeShellGreen";
_obj addItemToVest "SmokeShellBlue";
_obj addItemToBackpack "ToolKit";
_obj addHeadgear "OPTRE_UNSC_CH252_Helmet2_Vacuum_URB";
