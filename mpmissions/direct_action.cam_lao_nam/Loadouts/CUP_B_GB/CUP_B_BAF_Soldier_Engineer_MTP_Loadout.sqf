...
_obj addWeapon "CUP_launch_M136_Loaded";
_obj addSecondaryWeaponItem "CUP_M136_M";
...
_obj addVest "CUP_V_B_BAF_MTP_Osprey_Mk4_Engineer";
_obj addBackpack "CUP_B_Motherlode_MTP";
...
_obj addItemToBackpack "CUP_M136_M";
