...
comment "Add weapons";
_obj addWeapon "vn_m1carbine";
_obj addPrimaryWeaponItem "vn_b_carbine";
_obj addPrimaryWeaponItem "vn_o_3x_m84";
_obj addPrimaryWeaponItem "vn_carbine_15_mag";
_obj addWeapon "vn_m1911";
_obj addHandgunItem "vn_m1911_mag";

comment "Add containers";
_obj forceAddUniform "vn_b_uniform_macv_01_07";
_obj addVest "vn_b_vest_usarmy_08";
...
for "_i" from 1 to 8 do {_obj addItemToVest "vn_carbine_15_mag";};
_obj addHeadgear "vn_b_helmet_m1_03_01";
