...
_obj addVest "vn_b_vest_usarmy_03";
...
for "_i" from 1 to 3 do {_obj addItemToBackpack "SatchelCharge_Remote_Mag";};
for "_i" from 1 to 2 do {_obj addItemToBackpack "vn_mine_m18_range_mag";};
_obj addHeadgear "vn_b_helmet_m1_07_01";
