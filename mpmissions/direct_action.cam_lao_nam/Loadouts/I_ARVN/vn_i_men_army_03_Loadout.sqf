...
_obj addPrimaryWeaponItem "vn_s_m3a1";
_obj addPrimaryWeaponItem "vn_m3a1_mag";
_obj addWeapon "vn_m1911";
_obj addHandgunItem "vn_m1911_mag";

comment "Add containers";
_obj forceAddUniform "vn_b_uniform_macv_01_07";
_obj addVest "vn_b_vest_usarmy_07";
...
for "_i" from 1 to 5 do {_obj addItemToVest "vn_m3a1_mag";};
_obj addItemToBackpack "vn_b_item_medikit_01";
for "_i" from 1 to 20 do {_obj addItemToBackpack "vn_b_item_firstaidkit";};
_obj addHeadgear "vn_b_helmet_m1_06_01";
